public class ArithExpression {
                ...
                switch (ch){
                    ...
                    case ')':String out="";
                        while ((out=stack.pop())!=null&&!out.equals("(")){
                            postfix.append(out);}i++;break;
                    default:while (!stack.isEmpty()&&!stack.peek().equals("(")
    ...
    public int tovalue(StringBuffer postfix){
        Stack<java.lang.Integer> stack =new LinkedStack<java.lang.Integer>();
        int value=0;
    ...
    public static void main(String[] args) {
        String infix="554+128*(1077+128)-256";
